import type { COSEAlgorithmIdentifier, CredentialDeviceType, RegistrationResponseJSON, WebAuthnCredential } from '@simplewebauthn/server/src/types/index.js';
import { type AttestationFormat, type AttestationStatement } from '@simplewebauthn/server/src/helpers/decodeAttestationObject.js';
import type { AuthenticationExtensionsAuthenticatorOutputs } from '@simplewebauthn/server/src/helpers/decodeAuthenticatorExtensions.js';
/**
